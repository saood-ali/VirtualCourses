...
const ElectricBorder = ({
  ...
  // 2. 2D Noise Function (Perlin-like)
  ...
  // 3. Octave Noise (Layers noise for detail)
  ...
  // 4. Calculate Points on a Rounded Rectangle
  ...
  useEffect(() => {
    ...
    const displacement = 60; // Space reserved for the jitter
    ...
    const drawElectricBorder = currentTime => {
      ...
      const sampleCount = Math.floor(approximatePerimeter / 2); // Resolution of the line
