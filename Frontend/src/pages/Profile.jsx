...
function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 py-10 flex items-center justify-center">
      ...
      <BsArrowReturnLeft className="absolute top-[8%] left-[5%] w-[22px] h-[22px] cursor-pointer" onClick={()=>navigate("/")} />
      ...
      text-[30px] border-2 bg-black border-white"
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          active:bg-[#4b4b4b] cursor-pointer transition" onClick={()=>navigate("/edit-profile")}>
            Edit Profile
          </button>
          <button>
            Logout
