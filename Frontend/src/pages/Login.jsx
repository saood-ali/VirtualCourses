...
import { X, Mail, Lock, Eye, EyeOff, Sparkles, Monitor, Shield } from "lucide-react";
      ...
      <div className="max-w-[1024px] w-full md:w-[90%] h-auto lg:min-h-[650px] bg-white border border-[#E5E7EB] rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.05)] overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="relative w-full lg:w-1/2 p-6 sm:p-8 lg:py-8 lg:px-10 flex flex-col justify-between">
          ...
          <div className="my-auto py-4 space-y-5 max-w-[410px] w-full mx-auto">
            ...
            {/* Login Inputs */}
            <form className="space-y-3.5" onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
              {/* Email Input */}
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <span 
                    className="text-xs font-semibold text-[#FFD400] hover:text-[#e0bb00] transition-colors cursor-pointer"
              ...
              >
                {loading ? <ClipLoader size={20} color="#111111" /> : "Sign In"}
              </button>
            </form>
